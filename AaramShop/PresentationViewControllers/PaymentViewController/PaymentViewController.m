...
-(void)createDataForCheckout
{
    ...
    [dict setObject:_strStore_name forKey:kStore_name];
    ...
    cmPayment.pamentDataDic=dict;
    [self performSegueWithIdentifier:@"PAYMENTMODE" sender:nil];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(nullable id)sender {
    ...
    if ([segue.identifier isEqualToString:@"PAYMENTMODE"])
    {
    
        PaymentModeViewController*destViewController = segue.destinationViewController;
        destViewController.cmPayment =cmPayment;
        }
