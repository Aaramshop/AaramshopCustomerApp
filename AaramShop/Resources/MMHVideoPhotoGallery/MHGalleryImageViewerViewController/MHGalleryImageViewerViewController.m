...
//    [self.navigationController.navigationBar setBarTintColor:[UIColor colorWithRed:123.0/255.0 green:134.0/255.0 blue:143.0/255.0 alpha:1.0]];
...
-(void)viewDidLoad{
    ...
    if ([AppManager sharedManager].isComingFromChat == YES) {
        self.navigationItem.hidesBackButton = YES;
        UIBarButtonItem *doneBarButton =  [[UIBarButtonItem alloc] initWithTitle:@"Done" style:UIBarButtonItemStyleBordered target:self action:@selector(donePressed)];//[UIBarButtonItem.alloc initWithBarButtonSystemItem:UIBarButtonSystemItemDone
                                                                         //             target:self
