...
static const CGFloat kTabbarDefaultHeight = 49;
...
- (void)viewDidLoad {
    ...
    _contentScrollView.frame = CGRectMake(0,kYSLScrollMenuViewHeight, self.view.frame.size.width, self.view.frame.size.height - (_topBarHeight + kYSLScrollMenuViewHeight + kTabbarDefaultHeight));
