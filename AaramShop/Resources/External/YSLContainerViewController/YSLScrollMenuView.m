...
static const CGFloat kYSLScrollMenuViewWidth  = 160;//120;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _itemfont = [UIFont fontWithName:kRobotoRegular size:15.0];

//        _itemTitleColor = [UIColor colorWithRed:114.0/255.0 green:114.0/255.0 blue:114.0/255.0 alpha:1.0];
        _itemTitleColor = [UIColor whiteColor];

//        _itemSelectedTitleColor = [UIColor colorWithRed:44.0/255.0 green:44.0/255.0 blue:44.0/255.0 alpha:1.0];
