...
#define kGetHomeStoreURL					@"getHomeStores"
...
#define kDeleteShopperAddressURL             @"deleteShopperAddress"
#define kDeleteHomeStoreURL                   @"deleteHomeStore"
