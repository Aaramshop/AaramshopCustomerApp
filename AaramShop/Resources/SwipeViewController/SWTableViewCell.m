...
//    self.cellScrollView.backgroundColor = [UIColor redColor];
...
//    if (![_leftUtilityButtons sw_isEqualToButtons:rightUtilityButtons]) {
//        _leftUtilityButtons = rightUtilityButtons;
//        
//        self.leftUtilityButtonsView.utilityButtons = rightUtilityButtons;
//        
//        [self.leftUtilityButtonsView layoutIfNeeded];
//        [self layoutIfNeeded];
//    }
...
//    _leftUtilityButtons = rightUtilityButtons;
//    
//    [self.leftUtilityButtonsView setUtilityButtons:rightUtilityButtons WithButtonWidth:width];
//    
//    [self.leftUtilityButtonsView layoutIfNeeded];
//    [self layoutIfNeeded];
}
