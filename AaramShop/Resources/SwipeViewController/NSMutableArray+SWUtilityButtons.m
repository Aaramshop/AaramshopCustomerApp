...
- (void)sw_addUtilityButtonWithBackgroundImage:(UIImage *)icon attributedTitle:(NSMutableAttributedString *)title
{
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    [button setBackgroundImage:icon forState:UIControlStateNormal];
    
    [button setAttributedTitle:title forState:UIControlStateNormal];
    button.titleLabel.font=[UIFont fontWithName:@"Roboto-Medium" size:10.0f];
    button.contentHorizontalAlignment=UIControlContentHorizontalAlignmentCenter;
    button.contentEdgeInsets = UIEdgeInsetsMake(50, 0, 0, 0);
